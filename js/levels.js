...
(function () {
  ...
  EL.Levels = [
    ...
    },
    {
      ...
      cycleSeconds: 10,
      spawn: { x: 40, y: 350 },
      exit: { x: 742, y: 90, w: 40, h: 48 },
      platforms: [
        GROUND,
        { x: 700, y: 140, w: 100, h: 20 },
      ],
      movers: [{ id: 'm1', x: 380, y: 340, w: 70, h: 18, axis: 'y', distance: 260, period: 10 }],
      buttons: [{ id: 'p1', x: 130, y: 380, w: 55, h: 20 }],
      doors: [{ id: 'd1', x: 300, y: 260, w: 20, h: 140, requires: ['p1'] }],
      lasers: [],
      boxes: [],
      hint: 'Hold the gate open, then time your jump onto the rising elevator.',
      par: { time: 20, echoes: 1 },
    },
    {
      name: '8 · Three Echoes',
      cycleSeconds: 10,
      ...
      movers: [],
      buttons: [
        { id: 'p1', x: 120, y: 380, w: 50, h: 20 },
        { id: 'p2', x: 300, y: 380, w: 50, h: 20 },
        { id: 'p3', x: 480, y: 380, w: 50, h: 20 },
      ],
      doors: [
        { id: 'd1', x: 220, y: 300, w: 20, h: 100, requires: ['p1'] },
        { id: 'd2', x: 400, y: 300, w: 20, h: 100, requires: ['p1', 'p2'] },
        { id: 'd3', x: 620, y: 300, w: 20, h: 100, requires: ['p2', 'p3'] },
      ],
      lasers: [],
      boxes: [],
    ...
    },
    {
      ...
      movers: [{ id: 'm1', x: 500, y: 340, w: 80, h: 18, axis: 'y', distance: 200, period: 10 }],
      buttons: [
        { id: 'p1', x: 110, y: 380, w: 50, h: 20 },
        { id: 'p2', x: 260, y: 380, w: 50, h: 20 },
        { id: 'p3', x: 620, y: 380, w: 50, h: 20 },
      ],
      doors: [
        { id: 'd1', x: 200, y: 300, w: 20, h: 100, requires: ['p1'] },
        { id: 'd2', x: 620, y: 260, w: 20, h: 140, requires: ['p2', 'p3'] },
      ],
      lasers: [{ id: 'l1', x1: 420, y1: 0, x2: 420, y2: 220, requires: 'p2' }],
      boxes: [{ id: 'b1', x: 300, y: 362, w: 34, h: 34 }],
      hint: 'Everything at once. Use every echo you have.',
      par: { time: 45, echoes: 5 },
    },
  ];
})();
